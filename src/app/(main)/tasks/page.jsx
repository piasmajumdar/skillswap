...
export default function PublicTasksPage() {
  ...
  return (
    <main className="mx-auto w-11/12 max-w-7xl py-5 sm:py-8">
      ...
      <section className="mx-auto mt-5 grid max-w-5xl gap-3 rounded-2xl border border-slate-200 bg-white p-3 shadow-sm sm:grid-cols-[minmax(0,1fr)_220px_180px]">
      ...
      <div className="mt-5 grid gap-8 md:grid-cols-[190px_minmax(0,1fr)] lg:grid-cols-[220px_minmax(0,1fr)]">
